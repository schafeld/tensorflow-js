...
/** Model
  * input layer (shape of [8] pitch sensor values),
  * then 3 hidden fully-connected layers with ReLU activation units,
  * followed by one softmax output layer consisting of 7 units (representing number of the output pitch types).
 */
